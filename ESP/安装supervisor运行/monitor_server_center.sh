...
# 构建Docker镜像
docker build -t my-monitor-server-center-app-supervisord .

# 运行Docker容器
docker run --name my-monitor-server-center-supervisord -it -p 9090:9090/udp my-monitor-server-center-app-supervisord
