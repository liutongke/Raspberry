...
def decode_payload(byte_data):
    ...
    device_id = device_id_data_stream.decode()
    return device_id, payload_data_stream

# data = encode_payload("bytes dance")
# print(data)
# device_id, payload = decode_payload(data)
# print(decode_payload(data))
# return device_id_data_stream, payload_data_stream
# def decode_payload(byte_data):
#     buffer = io.BytesIO(byte_data)
#     start_index = 0  # 起始索引（包含） 设置截取范围
